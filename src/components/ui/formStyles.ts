...
export const LABEL_STYLE =
  "block text-[10px] uppercase tracking-widest text-text-muted mb-2";

export const INPUT_STYLE =
  "w-full bg-surface border border-border px-4 py-3 text-xs text-text-primary focus:border-[#ff7d27] focus:outline-none transition-colors placeholder:text-text-muted";
