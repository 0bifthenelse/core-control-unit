  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-[#5a6070] hover:text-[#ff7d27] transition-colors duration-200 px-2 py-1.5 border border-[#1e2330] hover:border-[#ff7d27]/40"
        ...
        >
          {locales.map(({ code, label }) => (
            <button
              ...
              className={`w-full text-left px-3 py-1.5 text-[10px] uppercase tracking-widest transition-colors duration-150 ${
                locale === code
