...
export async function StickyContact() {
  ...
  return (
    <a
      href="#contact"
      className="fixed bottom-6 left-6 right-auto sm:left-auto sm:right-6 z-40 inline-flex items-center gap-2 border-2 border-surface bg-[#ff7d27] px-5 py-3 text-xs uppercase tracking-widest text-black font-bold hover:bg-[#e06b1a] transition-colors duration-200 shadow-[0_0_20px_rgba(255,125,39,0.35)] hover:shadow-[0_0_28px_rgba(255,125,39,0.5)]"
