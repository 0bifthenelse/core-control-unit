    ...
    <main className="pt-32 pb-24 px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="mt-3 text-3xl sm:text-4xl font-bold text-[#e8eaf0] uppercase tracking-tight mb-4">
            {item.title}
          </h1>
          <p className="text-sm text-[#5a6070] leading-relaxed max-w-3xl">{item.longDescription}</p>
        </div>
