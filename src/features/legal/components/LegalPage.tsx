  ...
  return (
    <main className="py-24 px-6">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl sm:text-4xl font-bold text-text-primary uppercase tracking-tight mb-8">
          {t("title")}
        </h1>
        ...
        <a
          ...
          className="mb-16 inline-flex items-center gap-2 rounded-md border border-[#1e2330] px-4 py-2 text-[10px] uppercase tracking-widest text-text-muted hover:text-[#ff7d27] hover:border-[#ff7d27] transition-colors"
        >
